...
- [ ] **Step 1: Финальная проверка перед удалением**
...
- [ ] **Step 1: Вычислить неиспользуемые**
...
- [ ] **Step 1: Извлечь эталонные блоки**
...
- [ ] **Step 2: Добавить symbols во все 15 спрайтов**
...
- [ ] **Step 3: Заменить инлайн-вхождения**
...
- [ ] **Step 4: Ручная проверка (запрос человеку)**
...
- [ ] **Step 1: Прочитать оба объявления каждого дубля**
...
- [ ] **Step 2: Проверка отсутствия регрессий каскада**
...
- [ ] **Step 1: По странице (одна итерация = одна страница)**
...
- [ ] **Step 2: Проверка каждой итерации**
...
- [ ] **Step 4: Ручная проверка (чекпоинт человеку)**
...
- [ ] **Step 1: Внести правки** (кратко, без переписывания всего файла).
- [ ] **Step 2: Commit**: `git commit -m "docs: update AGENTS.md and FIGMA.md after CSS restructure"`

---

### Task 8: Финал

- [ ] **Step 1:** `npx --yes stylelint "css/**/*.css"` — 0 ошибок.
- [ ] **Step 2:** adversarial-reviewer скилл по полному диффу ветки против master.
- [ ] **Step 3:** Отчёт пользователю: diff-статистика (строк до/после по каждому файлу), список страниц для ручной проверки с приоритетами, оставшиеся известные компромиссы.
